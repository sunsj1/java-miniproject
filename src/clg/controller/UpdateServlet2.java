...
public class UpdateServlet2 extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		u.setSub1mark(u1.getSub1mark());
		u.setSub2mark(u1.getSub2mark());
		u.setSub3mark(u1.getSub3mark());
		u.setSub4mark(u1.getSub4mark());
		u.setSub5mark(u1.getSub5mark());
		u.setSub6mark(u1.getSub6mark());
		u.setOutoff(u1.getOutoff());
