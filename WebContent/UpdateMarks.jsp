...
<body bgcolor="purple">
	...
	<input type="radio" name="gender" value="other" <c:if test="${data.gender=='other'}">checked="checked"</c:if>>Other</td>
			...
			<tr><td><h4>
						<font color="yellow">Marks:-</font></td>
						<td><h4>
						<font color="yellow">Sub1:-</font>
				<input type="text" name="sub1mark"
					 value="${data.sub1mark}">
					 <font color="yellow">Sub2:-</font>
				<input type="text" name="sub2mark"
					 value="${data.sub2mark}"><br>
					 <font color="yellow">Sub3:-</font>
				<input type="text" name="sub3mark"
					 value="${data.sub3mark}">
					 <font color="yellow">Sub4:-</font><br>
				<input type="text" name="sub4mark"
					 value="${data.sub4mark}">
					 <font color="yellow">Sub5:-</font>
				<input type="text" name="sub5mark"
					 value="${data.sub5mark}">
					 <font color="yellow">Sub6:-</font>
				<input type="text" name="sub6mark"
					 value="${data.sub6mark}">
					</h4></td>
						</tr>
						<tr>
				<td><h4>
						<font color="yellow">Outoff :-</font></td>
				<td><input type="text" name="outoff"
					 value="${data.outoff}">
					</h4></td>
			</tr>
			<tr>
