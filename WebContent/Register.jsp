	...
	<form action="register">
		...
		<table align="center">
			...
			<tr>
				...
				<tr>
				<td><font color="yellow">Role :-</font></td><td><input readonly="readonly" type="text" name="role" value="Head Of Deaprtment" placeholder="rolename" class="form-control inputdefault">
			</td></tr>
			<tr>
