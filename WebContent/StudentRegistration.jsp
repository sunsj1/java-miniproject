		...
		<table align="center">
			...
			<tr>
				...
				<td><input type="text" name="mobile"
					placeholder="eg. 967*****66"></td>
			</tr>
			<tr>
				<td><h4>
						<font color="yellow">Email :-</font></td>
				<td><input type="text" name="email" id="email"
					placeholder="test@example.com" onkeyup="checkMailStatus(1)"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input readonly="readonly" type="text" name="role"
					value="Student" placeholder="rolename"
			...
			<tr>
				...
				<td><input type="password" name="password"
					placeholder="Type a password" id="password1"></td>
			</tr>
			<tr>
				<td><h4>
						<font color="yellow">Confirm Password :-
					</h4></td>
				<td><input type="password" id="confirmpassword1"
					placeholder="Type a password again" onkeyup="check(2)"> <span
					id='message'></span></td>
			</tr>
			<tr>
